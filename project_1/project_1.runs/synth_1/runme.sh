...
HD_PWD='/home/sky/Git_repos/thesisSimulations/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ldpcenc_fixpt_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ldpcenc_fixpt_tb.tcl
