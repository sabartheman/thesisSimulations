...
HD_PWD='/home/sky/Git_repos/thesisSimulations/autogen_bch_vhdl/autogen_bch_vhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCH_VHDL_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCH_VHDL_tb.tcl
